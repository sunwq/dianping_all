...
public class test {
    ...
    public static void main(String[] args) throws IOException{
        String s = "E:\\Download\\temp\\files.txt";
        File  file = new File(s);

        for(String filename:FileUtils.readLines(file,"utf-8")) {
        Map<String,Object> data = null;
        System.out.println("####################################################"+filename+"####################################################");
        try {
            Thread.sleep(200);
            Document doc = Jsoup.parse(new File("E:\\Download\\temp\\test1\\"+filename),"utf-8");
