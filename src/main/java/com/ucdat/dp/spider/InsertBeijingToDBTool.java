 ...
 */
public class InsertBeijingToDBTool {
    private static final String SQL1 = "INSERT INTO `meishi_info_beijing_bupa`(" +
            "`shop_id`," +
            "`shop_name`," +
            "`shop_country`," +
            "`shop_city`," +
            ...
            "`datasource`," +
            "`lnglat_source`" +
            ") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE shop_name = shop_name; ";
    ...
    private static final String SQL2 = "INSERT INTO `meishi_comment_beijing`(`shop_id`,`comment_time`,`comment_score`" +
...
//            String tempFile = successFile+ file_i +".json";
            String successFile = "D:/data/beijing/bupa/meishi_success_task_ex2.json";
