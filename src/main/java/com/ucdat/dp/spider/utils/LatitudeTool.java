...
/**
 * Created by liyan on 16-12-4.
 */
public class LatitudeTool {
...
//       如果有代理，要设置代理，没代理可注释
     // System.setProperty("http.proxyHost","10.112.180.189");
    ...
    public static void main(String[] args) {
        Map<String, String> json = LatitudeTool.getGeocoderLatitude("保定华北电力大学");
